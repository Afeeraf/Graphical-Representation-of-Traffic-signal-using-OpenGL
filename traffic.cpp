...
glColor3f(1,1,1);
drawstring(100,300,0.0,"VIDYAKUMAR GV  (4BP09CS036)");
glColor3f(1,1,1);
drawstring(100,240,0.0,"TIBIN THOMAS   (4BP09CS035)");
glColor3f(1,0.5,0);
drawstring(980,400,0.0,"GUIDES:");
glColor3f(1,1,1);
drawstring(930,300,0.0,"Ms. NIKITHA V S");
glColor3f(1,1,1);
drawstring(930,240,0.0,"  Mr. ATEEQ");
glColor3f(1,0.1,1);
